    ...
    def handle(self, *args, **options):
        ...
        for config in room_configurations:
            ...
            if created:
                ...
                self.stdout.write(f'Room type already exists: {config["name"]}')
            ...
            for room_number in config['rooms']:
                ...
                if room_created:
                    ...
                    self.stdout.write(f'  Room already exists: {room_number}')
        
        self.stdout.write(
            self.style.SUCCESS('Successfully setup all rooms and room types!')
        )