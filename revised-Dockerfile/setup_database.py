...
def setup_database():
    print("🏨 Setting up room types and rooms...")
    ...
    # Create users
    users = [
        ('superadmin', 'snow2024!', 'SUPER', True, True),
        ('admin', 'admin2024!', 'ADMIN', False, True),
        ('frontdesk', 'front2024!', 'MEMBER', False, False)
    ]

    for username, password, user_type, is_superuser, is_staff in users:
    ...
    print(f"🎉 Setup completed! Rooms: {Room.objects.count()}, Users: {CustomUser.objects.count()}")
